...
const servicesData = [
  {
    ...
    subtitle:
      'Branded content made to engage, inform, and connect — formatted and styled for modern platforms and attention spans',
    items: [
  ...
  },
  {
    ...
    subtitle: 'Capturing raw, real, and unforgettable moments — from intimate gatherings to major public events',
    items: [
...

  {
    ...
    subtitle:
      'Helping individuals express their identity and craft a cohesive, creative visual presence for their brand, career, or portfolio.',
    items: [
  ...
  },
  {
    ...
    subtitle:
      'Guiding your creative vision — from ideas to execution — to ensure every visual tells the right story with intention and style',
    items: [
