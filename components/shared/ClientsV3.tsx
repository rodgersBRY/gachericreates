...
// Data-----------------
const topContent = ['Photography', 'Social Media', 'Digital Marketing', 'Branding', 'Story Telling']
const bottomContent = [
  'Wildlife Storytelling Photography',
  'Digital PR',
  'Image Licensing & Prints',
  'Portfolio Agency Collaboration',
  'Conservation Photography Sales',
]
